...
const routes: Routes = [
  ...
  { path: 'component/skeleton-posts', loadChildren: () => import('./pages/component/skeleton-posts/skeleton-posts.module').then(m => m.SkeletonPostsPageModule) },
  { path: 'component/post', loadChildren: () => import('./pages/component/post/post.module').then(m => m.PostPageModule) },
  { path: 'component/skeleton-post', loadChildren: () => import('./pages/component/skeleton-post/skeleton-post.module').then(m => m.SkeletonPostPageModule) },
  ...
  { path: 'component/skeleton-video', loadChildren: () => import('./pages/component/skeleton-video/skeleton-video.module').then(m => m.SkeletonVideoPageModule) },
